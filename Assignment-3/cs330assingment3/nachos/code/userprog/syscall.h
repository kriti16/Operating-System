...
void system_SemOp (int semid, int adjust);

int system_SemCtl (int semid, unsigned command, int *val);

int system_CondGet (int key);

void system_CondOp (int condid, unsigned op, int semid);

int system_CondRemove (int condid);

unsigned system_ShmAllocate (unsigned size);
