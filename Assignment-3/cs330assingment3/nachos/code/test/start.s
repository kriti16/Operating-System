...
system_CondOp:
        ...
        .globl system_CondRemove
        .ent    system_CondRemove
system_CondRemove:
        addiu $2,$0,syscall_CondRemove
        syscall
        j       $31
        .end system_CondRemove

        .globl system_ShmAllocate
        .ent    system_ShmAllocate
system_ShmAllocate:
	addiu $2,$0,syscall_ShmAllocate
        syscall
        j       $31
        .end system_ShmAllocate
